...
export function ExamResultsStep() {
  const { state, nextStep, retryFinalExam, prevStep } = useTraining();
      ...
      <div className="animate-fadeIn">
        <div className="text-center mb-8">
          ...
          <h1 className="text-[28px] lg:text-[36px] font-bold tracking-[-0.03em] text-navy-950 mb-2">
            {attempt.passed ? 'Exam Passed!' : 'Exam Not Passed'}
          </h1>

          <p className="text-[17px] text-slate-500 mb-1">
            NWS Water Specialist Final Exam
          </p>
          ...
          <div className="flex items-center justify-center gap-4 mt-4">
            ...
            <div className="text-left">
              <div className="text-[13px] text-slate-400">Passing score: 85%</div>
